<div>
    ...
    <main class="mt-4 pt-5 pb-5 mb-4 container d-flex justify-content-center">
        <div class="col-lg-8 col-12">
            <div class="">
                <img src="{{ asset('React.jpg') }}" alt="" height="350px" class="d-block border w-100" style="border-radius: 15px">
            </div>
            ...
            <div class="mt-3">
                ...
                <p>
                    ...
                    sapiente itaque! Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati quis quos beatae et earum dolores
                    facilis, eveniet soluta aliquid non ratione modi nobis accusamus voluptas nihil expedita, voluptates
                    sapiente itaque!
                </p>
            </div>
            ...
            <div class="mt-3">
                ...
                <div id="carouselExampleIndicators" class="carousel slide border" data-bs-ride="true"  style="border-radius: 15px">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="{{ asset('React.jpg') }}" height="350px" class="d-block w-100" alt="..."  style="border-radius: 15px">
                        </div>

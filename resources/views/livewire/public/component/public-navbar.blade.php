                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu border-0 shadow-sm" style="{{ env('bgColor100') }}">
                            @forelse ($produk as $data)
                                <li><a class="dropdown-item text-dark text-decoration-none" href="{{ $data->link }}"
                                        target="_blank" rel="noopener noreferrer">{{ $data->nama }}</a></li>
                            @empty
                            @endforelse
                            ...
                            <li><a class="dropdown-item @if (Request::is('produk*')) active @endif"
                                    href="{{ url('produk', []) }}">Semua produk</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link @if (Request::is('layanan*')) active @endif dropdown-toggle"
                            href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Layanan
                        </a>
                        <ul class="dropdown-menu border-0 shadow-sm" style="{{ env('bgColor100') }}">
                            ...
                            <li>
                                <a class="dropdown-item @if (Request::is('layanan/jenis/'. $data->slug)) active @endif"
                                    href="{{ url('layanan/jenis', $data->slug) }}">{{ $data->nama }}</a>
                            </li>
                            @endforeach
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item @if (Request::is('layanan/jenis')) active @endif"
                                    href="{{ url('layanan/jenis') }}">Semua layanan</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link @if (Request::is('portofolio*')) active @endif" aria-current="page"
                            href="{{ url('portofolio') }}">Portofolio</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link @if (Request::is('tentang')) active
                        @elseif (Request::is('kontak'))
                        active @endif dropdown-toggle"
                            href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Mengenai kami
                        </a>
                        <ul class="dropdown-menu border-0 shadow-sm" style="{{ env('bgColor100') }}">
                            <li><a class="dropdown-item @if (Request::is('tentang')) active @endif"
                                    href="{{ url('tentang', []) }}">Tentang</a></li>
                            <li><a class="dropdown-item @if (Request::is('kontak')) active @endif"

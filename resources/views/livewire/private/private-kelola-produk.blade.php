            ...
            <div class="card-body py-2">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="">
                        @if($tambah)
                        @else
                        <button wire:click='formtambah' type="button" class="btn btn-primary rounded-pill">Tambah produk</button>
                        @endif
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <form wire:submit.prevent='tambah' enctype="multipart/form-data">
                    ...
                    <div class="mt-1">
                        ...
                        <input type="text" id="singkat" class="form-control" placeholder="Singat mengenai produk">
                    </div>
                    <div class="mt-1">
                        <label for="keterangan">Keterangan</label>
                        <textarea id="keterangan"  rows="5" class="form-control"></textarea>
                    </div>
                    <div class="mt-1">
                        <label for="link">Link url</label>
                        <input type="text" id='link' class="form-control" placeholder="Link https://">
                    </div>
                    <div class="mt-2">
                        <button type="submit" class="btn btn-primary rounded-pill form-control">Simpan</button>
                    </div>
                </form>
                <button wire:click='formtutup' type="button" class="btn btn-secondary mt-2 rounded-pill form-control">Tutup</button>
            </div>
        </div>
       </div>
        @endif

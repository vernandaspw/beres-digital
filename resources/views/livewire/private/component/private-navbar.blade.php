                ...
                <div class="d-flex">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item me-3">
                            <a href="{{ url('login') }}" class="nav-link text-decoration-none text-white" type="submit">{{ auth()->user()->role }}</a>
                        </li>
                    </ul>
                    <a href="{{ url('logout') }}" class="btn btn-danger px-4 rounded-pill hoverdaftar text-white d-flex align-items-center"
